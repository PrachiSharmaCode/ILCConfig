(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/operators'), require('@angular/animations'), require('@angular/forms'), require('@angular/router'), require('rxjs'), require('@angular/common'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('angular-bootstrap-md', ['exports', 'rxjs/operators', '@angular/animations', '@angular/forms', '@angular/router', 'rxjs', '@angular/common', '@angular/core'], factory) :
    (factory((global['angular-bootstrap-md'] = {}),global.rxjs.operators,global.ng.animations,global.ng.forms,global.ng.router,global.rxjs,global.ng.common,global.ng.core));
}(this, (function (exports,operators,animations,forms,router,rxjs,common,i0) { 'use strict';
